...
## include "2007-02-03 00:00:00" since we need the Sat. illustrated on the x-axis of Plot4.
...
legend("topright", col = c("black", "red", "blue"), lty = c(1, 1, 1), cex = 0.75, bty = "n",
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

plot(powerConsDataSub$DateTime, powerConsDataSub$Voltage, type = "l", xlab = "datetime",
     ylab = "Voltage")

plot(powerConsDataSub$DateTime, powerConsDataSub$Global_reactive_power, type = "l",
     xlab = "datetime", ylab = "Global_reactive_power")

## Once the plots have been figured out, open the appropriate graphics file device;
